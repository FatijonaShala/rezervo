...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Vigu'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/vigu1.jpg" class="grid image-link">
                        <img src="foto/vigu1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/vigu2.jpg" class="grid image-link">
                        <img src="foto/vigu2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/vigu3.jpg" class="grid image-link">
                        <img src="foto/vigu3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                   <div class="swiper-slide">
                    <a href="foto/vigu1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Vigu</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Një vend i shkëlqyeshëm për të ngrënë!</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Një nga restorantet më moderne në rajonin e Mitrovicës, ku infrastruktura dhe natyra ndërthuren në një mënyrë që klientët të mund të shijojnë ushqimin dhe freskinë e lumit nën një relaksim të veçantë. Ajo ofron menu të pasur me kuzhinën tradicionale të Kënaqësisë bashkëkohore: mëngjes, drekë dhe darkë.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <p>Reviewed 9 month ago</p>
                                    </div>
                                    <div class="customer-rating">9.0</div>
                                </div>
                                <p class="customer-text">I can highly recommended this restaurant outside from the city center of mitrovica on the road direction zubin potok.The fresh trout is delicious and the prices are reasonable. The waiters are friendly and professional.Nice and modern ambience near a small river with lot of parking spaces.</p>
								<span>89 people marked this review as helpful</span>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed  99 days ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">1.0</div>
                                </div>
                                <p class="customer-text"> Food without salt!!</p>
									<span>0 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapvigu.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> M2 Kushtove<br> Mitrovicë 40000<br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 08:00 am - 22:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Vigu' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
