...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Koha'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/koha1.jpg" class="grid image-link">
                        <img src="foto/koha1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/koha2.jpg" class="grid image-link">
                        <img src="foto/koha2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/koha3.jpg" class="grid image-link">
                        <img src="foto/koha3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                        <div class="swiper-slide">
                    <a href="foto/koha1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Koha</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Restaurant familjar.</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Restaurant Koha ehste nje restaurant me tradite shumevjeqare ne qytetin e Mitrovicës,duke ju ofruar nje meny te shumellojshme dhe te larmishme,duke filluar nga sallatat e deri tek deserti.Nuk do te zhgenjeheni</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <p>Reviewed 7 month ago</p>
                                    </div>
                                    <div class="customer-rating">9.0</div>
                                </div>
                                <p class="customer-text">Amazing food and service, so good that we came back twice ;-) . We also got coffee by the house and is in a central area</p>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed  3 days ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">1.0</div>
                                </div>
                                <p class="customer-text"> It was terrible!</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapkoha.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Boulevard Isa Boletini<br> Mitrovicë <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 09:00 am - 23:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Koha' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
