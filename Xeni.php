...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Xeni'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/xeni2.jpg" class="grid image-link">
                        <img src="foto/xeni2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/xeni3.jpg" class="grid image-link">
                        <img src="foto/xeni3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/xeni1.jpg" class="grid image-link">
                        <img src="foto/xeni1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/xeni2.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Xeni Imperial</h5>
                    <p><span>$$$$$</span></p>
                    <p class="reserve-description"> Shërben mëngjes, drekë, darkë, pije dhe kafe</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Xeni Imperial, vend ideal për të gjitha eventet tuaja.Për dekorimin e eventit tuaj përkujdeset stafi profesional i drejtuar nga Znj. Valbone Jetishi.Shërben mëngjes, drekë, darkë, pije dhe kafe.Ka filluar në datën Maj 2013</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <p>Reviewed 10 months ago</p>
                                    </div>
                                    <div class="customer-rating">9.0</div>
                                </div>
                                <p class="customer-text">We attended with the family at a wedding. The staff works quick and pays attention to the table needs.The location is also easy to find since most people in the city know it.Smoking inside was allowed which is a big plus.The infrastructure (light, sound, special effects, decoration) in detail is thought through.I dont know the prices/chair, but i think its worth considering if you plan to hold your event in gjakova.!</p>
								<span>100 people marked this review as helpful</span>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">The terraces covered but the rain came inside and across the overhead wire of the chandeliers with a high risk of killing someone, or slipping on the damp floor .....</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapxeni.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Rruga Magjistrale Gjakovë - Prizren<br> Gjakovë 50000 <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Xeni' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
