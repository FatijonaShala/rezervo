...
$conn = mysqli_connect($servername, $username, $password, $dbname);
	...
	$klienti=$_POST['klienti'];
				...
				$query="select * from klienti WHERE ID='$ID'";
				...
				{
					$query= "insert into shfrytzues values('$ID','$emri','$mbiemri', '$username', '$password', '$klienti')";
					$query_run = mysqli_query($conn,$query);
...
<body>
<p><a href="home.php">...kthehu mbrapa</a></p>
	...
	<section id="content">
		<form method="post">
			...
			<div>
				...
				<option value="" selected="selected">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Klienti</option> 
				<option value="Admin">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;E Hënë</option> 
				<option value="Admin i Restoranit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;E Martë</option> 
