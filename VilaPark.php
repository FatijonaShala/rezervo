...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Vila'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/vilapark1.jpg" class="grid image-link">
                        <img src="foto/vilapark1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/vilapark2.jpg" class="grid image-link">
                        <img src="foto/vilapark2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/vilapark3.jpg" class="grid image-link">
                        <img src="foto/vilapark3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                 <div class="swiper-slide">
                    <a href="foto/vilapark1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Vila Park</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Një vend i shkëlqyeshëm!</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Vila Park është restoran familjar i cili gjendet në kilometrin e 12-të Prizren-Prevallë. Kuzhinë dhe shërbim profesional . Ju mirëpresim..</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    ...
                                    <div class="customer-rating">6.5</div>
                                </div>
                                <p class="customer-text">Very kindly ambient and staff. The toilets are so clean. It has outdoor and indoor restaurants. Staff speek lot of Balkan languages and also english. I will go again. I preferred to everybody..</p>
								<span>66 people marked this review as helpful</span>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed 90 days ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">1.0</div>
                                </div>
                                <p class="customer-text">Very bad service! Extreme bad service. A 40-year-old waitress who received the message has a very rough and unprofessional approach with very negative approaches. He was unable to give us the slightest explanation for any of the meals in the menu.</p>
									<span>99 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapvila.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Sharr Mountains Sredska <br> Prizren 20000 <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Vila' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
