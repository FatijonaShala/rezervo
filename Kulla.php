...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Kulla'" ;
...
<body>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/kulla1.jpg" class="grid image-link">
                        <img src="foto/kulla1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/kulla2.jpg" class="grid image-link">
                        <img src="foto/kulla2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/kulla3.jpg" class="grid image-link">
                        <img src="foto/kulla3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                 <div class="swiper-slide">
                    <a href="foto/kulla1.jpg" class="grid image-link">
    ...
    <section class="reserve-block">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Kulla e Zenel Beut</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Tradicionale dhe e mahnitshme.. </p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>"Restaurant Kulla e Zenel Beut është hapur me 22 qershor 2013, kjo kullë u ndërtua reth 170 vite më parë nga Zenel MahmutBegolli"</p>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text"> Best food ever! We had excellent food and wine at Kulla e Zenel Beut - definitely the best of our whole trip! Service and atmosphere are really really good as well. Prices are incredibly cheap. I highly recommend it to anyone visiting Pec!</p>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed 7 months ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">2.0</div>
                                </div>
                                <p class="customer-text">Iconic restaurant, set up in 18-th century traditional stone building, slow service, overpriced.</p>
                                <span>2 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapkulla.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> 51 William Walker <br> Peja 30000 <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 06:30 am - 16:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Kulla' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
