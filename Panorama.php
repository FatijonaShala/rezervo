...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Panorama'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/panorama1.jpg" class="grid image-link">
                        <img src="foto/panorama1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/panorama2.jpg" class="grid image-link">
                        <img src="foto/panorama2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/panorama3.jpg" class="grid image-link">
                        <img src="foto/panorama3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                 <div class="swiper-slide">
                    <a href="foto/panorama1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Panorama</h5>
                    <p><span>$$$$$</span></p>
                    <p class="reserve-description"> Pamja jone se bashku me nje mengjes te mire do te ju mahnis</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Hoteli ynë ju mundëson që gjatë veres, ju mund të shijoni ajrin e freskët jashtë dhe të mahniteni me pejsazhet e Rugoves.Gjatë nates ju do të relaksoheni me qetësinë e bjeshkëve. Ju garantojmë me një komoditet.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Breathtaking views, amazing in the middle of the mountain. The concept of drinking coffee with such a view is just perfect for me.</p>
								<span>55 people marked this review as helpful</span>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Very bad hotel.</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mappanorama.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Bogë <br> Peja 20000 <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Panorama' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
