        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/oda1.jpg" class="grid image-link">
                        <img src="foto/oda1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/oda2.jpg" class="grid image-link">
                        <img src="foto/oda2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/oda3.jpg" class="grid image-link">
                        <img src="foto/oda3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
           <div class="swiper-slide">
                    <a href="foto/oda1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Oda e Junikut</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Pamja më e bukur!</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Oda e Junikut ndodhet strategjikisht në një zonë shumë të qetë dhe të bukur të qytetit të vogël. Për mbi 12 vjet në restorantin tonë ne kemi ofruar një përvojë unike ngrënie ku klientët vijnë për të shijuar pjatat tona të shijshme. Si përmbledhje, Oda e Junikut është një pikënisje e shkëlqyeshme për të vizituar Junikun.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Friendly and kind service, the cheapest prices I have a ever seen. Delicious food and beer. </p>
								<span>77 people marked this review as helpful</span>
	...
	?>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed  9 days ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">1.0</div>
                                </div>
                                <p class="customer-text"> You can find the better one!!</p>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapoda.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Agim Ramadani<br> Gjakova 51050<br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Oda' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
