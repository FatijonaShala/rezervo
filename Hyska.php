...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Hyska'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/hyska1.jpg" class="grid image-link">
                        <img src="foto/hyska1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/hyska2.jpg" class="grid image-link">
                        <img src="foto/hyska2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/hyska3.jpg" class="grid image-link">
                        <img src="foto/hyska3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                  <div class="swiper-slide">
                    <a href="foto/hyska1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Hyska</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description">Ushqim i shpejte dhe grill ne qytetin e Prizrenit</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Ushqim i mirë,lokal i thjeshtë! I përballueshme dhe shume freskët. Eshtë një vend i thjeshtë në një vendndodhje të mirë. Duket sikur  një vend mjaft popullor për një drekë / darkë të shpejtë në mesin e vendasve.</p>
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Friendly staff, taste good. Good location. Nice atmosphere in the evening.</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">The meat is not what you think it is.</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/maphyska.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Adem Jashari <br> Suhareke,Prizren<br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 08:30 am - 18:30 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Hyska' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
