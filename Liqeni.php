...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Liqeni'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/liqeni1.jpg" class="grid image-link">
                        <img src="foto/liqeni1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/liqeni2.jpg" class="grid image-link">
                        <img src="foto/liqeni2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/liqeni3.jpg" class="grid image-link">
                        <img src="foto/liqeni3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                  <div class="swiper-slide">
                    <a href="foto/liqeni1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Liqeni</h5>
                    <p><span>$$$$$</span></p>
                    <p class="reserve-description"> Shërben mëngjes, drekë, darkë, kafe dhe pije</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Një nga restorantet më të vjetra në Prizren, me traditë mbi 30 vjet në shërbimin e specialiteteve të peshkut të freskët. Ka një ambient të qetë dhe modern, një tarracë të bukur, nën të cilën rrjedh lumi; një pamje në Liqenin e Drinit të Bardhë, malet Sharri dhe Pashtriku; ofron mundësi të shkëlqyeshme për shëtitje.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Nice place with different and attractive foods with a pleasant taste.</p>
								<span>90 people marked this review as helpful</span>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed 3 year ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">2.0</div>
                                </div>
                                <p class="customer-text">Bad fish.</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapliqeni.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Autostradë Dr. Ibrahim Rugova <br> Prizren 20000 <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 10:00 am - 22:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Liqeni' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
