    ...
    <section class="main-block light-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="add-listing-wrap">
                        <h2>Mirë se erdhe Administrator</h2>
                        <p>Këtu ju mund të kryeni detyrat e juaja. </p>
                        <p>Ju urojmë suksese!</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="shiko_restorantet.php" class="btn btn-danger">SHIKO RESTAURANTET E REGJISTRUARA </a>
                    </div>
                </div>
            </div>
			<br><br><br>
			<div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="regjistrimi_klienteve.php" class="btn btn-danger">SHIKO KLIENTET E REGJISTRUAR</a>
                    </div>
                </div>
            </div>
        </div>
