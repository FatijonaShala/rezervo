...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Bujana'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/bujana1.jpg" class="grid image-link">
                        <img src="foto/bujana1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/bujana2.jpg" class="grid image-link">
                        <img src="foto/bujana2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/bujana3.jpg" class="grid image-link">
                        <img src="foto/bujana3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                 <div class="swiper-slide">
                    <a href="foto/bujana1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Bujana</h5>
                    <p><span>$$$$$</span></p>
                    <p class="reserve-description"> Mëngjesi, Darka, Dreka</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Meny te pasur traditcionale dhe specialitete nga mishi i pules,vicit, peshkut, sallata dhe pica gjithashtu dhe shume ushqime te tjera.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        <h6>Delicious and affordable</h6>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                ...
                                <p class="customer-text">I had the most amazing experience at this restaurant. You may choose to sit inside or outside in the shade or in the sun and enjoy the view of the hills. The traditional breakfast was diverse, the portions were big, and the service was expedient. Plenary of parking and great prices.</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text"> The table it was not cleaned and it was so cold</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapbujana.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Unbekannt<br> Gjilan <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Bujana' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
