...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Oda '" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/orchide1.jpg" class="grid image-link">
                        <img src="foto/orchide1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/orchide2.jpg" class="grid image-link">
                        <img src="foto/orchide2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/orchide3.jpg" class="grid image-link">
                        <img src="foto/orchide3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/orchide1.jpg" class="grid image-link">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Është restoranti më i mirë në vendin tonë ku mund të hani dhe pini dhe sigurisht që ju do të shijoni ushqimin dhe pijet dhe është një personel i mirë shërbimi.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        <h6>Super services</h6>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed 25 days ago</p>
                                    </div>
                                    <div class="customer-rating">8.0</div>
                                </div>
                                <p class="customer-text">Service is excellent and staff very nice.Located in center of the city Ferizaj.Delicious food.I recommend everybody to visit</p>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed  6 months ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">3.0</div>
                                </div>
                                <p class="customer-text"> The waiter came to order drinks without bringing us the menus.</p>
									<span>25 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
								<br><br><br>
<br><br><br>
<br><br><br>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/maporchide.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Str. Ahmet Kaqiku No. 35<br> Ferizaj <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 07:00 am - 16:30 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Orchide' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
