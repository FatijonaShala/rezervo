...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Ambient'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/ambient1.jpg" class="grid image-link">
                        <img src="foto/ambient1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/ambient2.jpg" class="grid image-link">
                        <img src="foto/ambient2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/ambient3.jpg" class="grid image-link">
                        <img src="foto/ambient3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                   <div class="swiper-slide">
                    <a href="foto/ambient1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Ambienti</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Ambinet i qetë familjar.</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Restauranti , Ambient " u hap me 6 mars të vitit 2006, nën kalanë e Prizrenit pranë Lum Bardhit me një pamje unike në qytetin më të lashtë të Kosovës, me një ambient ku ju nga restauranti ynë mund të shihni një pamje mahnitëse duke u frekuentuar ne qytetin tonë.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Tasty food and an interesting location with a stunning view on Prizren city.</p>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed 30 months ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">1.0</div>
                                </div>
                                <p class="customer-text">I ordered the peppersteak. The steak itself was overdone, not juicy, no taste. The peppersauce mediocre and not heated well. Potato hard, under cooked. All in all bad experience. Plenty of other options in town, avoid this one.</p>
									<span>67 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
								<br><br><br>
<br><br><br>
<br><br><br>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapambient.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Vatra Shqiptare <br> Prizren 20000 <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 09:00 am - 17:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Ambient' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
