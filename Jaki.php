...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Jaki'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/jaki1.jpg" class="grid image-link">
                        <img src="foto/jaki1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/jaki2.jpg" class="grid image-link">
                        <img src="foto/jaki2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/jaki3.jpg" class="grid image-link">
                        <img src="foto/jaki3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                    <div class="swiper-slide">
                    <a href="foto/jaki1.jpg" class="grid image-link">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Jaki GRILL është më shumë se një vend BBQ. Enët që i gjeni atje e bëjnë atë të jetë një restorant tradicional shqiptar. Vendosja është shumë e ngrohtë dhe klasike. Ekziston një larmi e madhe e vakteve dhe specialiteteve, kështu që nëse jeni në Kosovë, na vizitoni.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Me and my girlfriend who is from Kosovo ate there and it was really delicious! Very good authentic albanian food and the waiters were really friendly. What i always look for my sound weird but it's the toilet.. when restaurants have nice toilets you can be 100% it's good. And they were perfectly clean. I can really recommend this place and we'll definitely go there many times again! Best restaurant in gjakova!</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">It's good but not so much option to choose a food.</p>
									<span>3 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
								<br><br><br>
<br><br><br>
<br><br><br>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapjaki.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Rruga Gjon Nikolle Kazazi <br> Gjakove 50000 <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 09:00 am - 19:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Jaki' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
