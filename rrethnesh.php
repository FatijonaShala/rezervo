            ...
            <div class="row">
              ...
              <span class="icon-menu"></span>
                     ...
                     <span class="icon-arrow-down"></span>
								...
								<li class="nav-item">
                                        <a class="nav-link" href="shkyqja.php">LogOut</a>
                                    </li>
                            </ul>
                        </div>
                    </nav>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="add-listing-wrap">
                        <h2>Bëhu pjesë edhe ti</h2>
                        <p>Rezervo...n`KS është një website fenomenal dhe i sofistikuar për restaurante. është një mjet i bukur që ndjek të gjitha tendencat dhe teknologjitë më të fundit.  Për më tepër, Rezervo...n`KS është gjithashtu i pajtueshëm me të gjithë shfletuesit modernë të internetit. </p>
                        <p>"Le të jetë ushqimi ilaçi yt dhe ilaçi të jetë ushqimi yt."</p>
                        <p>Me dizajnin e pastër dhe të rafinuar në internet, Rezervo...n`KS ka një potencial të lartë për t'ju ndihmuar të rritni biznesin tuaj online në nivelin e jashtëzakonshëm. Rriteni kaq shumë, sa që restaurantet dhe bizneset e tjera të ushqimit do të jenë të etur për t'u bërë pjesë e faqes tonë. Por në fund,  është e sigurt që do të keni sukses.</p>
                    </div>
                </div>
            </div>
        </div>
