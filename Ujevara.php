...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Ujevara'" ;
...
<body>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/ujvara.jpg" class="grid image-link">
                        <img src="foto/ujvara.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/ujvara2.jpg" class="grid image-link">
                        <img src="foto/ujvara2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/ujvara1.jpg" class="grid image-link">
                        <img src="foto/ujvara1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/ujvara.jpg" class="grid image-link">
    ...
    <section class="reserve-block">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Ujevara e Drinit</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description">Pamje e mrekullueshme, një ajër i pastër dhe gatimi më i mirë i peshkut ...</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Për gjithë njerëzit që e gëzojnë natyrën dhe dëshirojnë ta shijojnë atë, Restoranti Ujvara e Drinit është vendi më i përsosur për ju. Restoranti është i vendosur pranë lumit Drini i Bardhë. Është një restorant i bukur dhe kur koha është e bukur ju mund të uleni në tarracë e cila është vendosur buzë lumit. I kemi kushtuar një rëdësi të veçantë dritareve, në mënyrë që t´ua bëjmë të mundur ta shijoni pamjen e bukur të natyrës që na rrethon edhe nga mbrenda gjatë ditëve të ftohta të dimrit.</p>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Amazing experience in Kosova!
The hotel is situated in a lovely place in the mountains. The rooms were spacious and very clean.
Amazing hospitality and service!!!
Special greetings to Agron and the entire hotel staff!!
Thank you all!</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Not that good</p>
                                <span>9 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapujevara.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Fsh. Radavc Radavc<br> Peja 30000 <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Ujevara' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
