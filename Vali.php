...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Vali'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/valiranch.jpg" class="grid image-link">
                        <img src="foto/valiranch.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/valiranch3.jpg" class="grid image-link">
                        <img src="foto/valiranch3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/valiranch2.jpg" class="grid image-link">
                        <img src="foto/valiranch2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/valiranch.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Vali Ranch</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Ambient relaksues</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Vali Ranch ka filluar se punuari me 2006, si nje restaurant me ranc te kuajve, e qe me gradualisht, fale punes tone dhe kerkesave te klientave tane, tanime jemi nje resort turistik me plote kuptimin e fjales. Ne Vali Ranch ju mund te organizoni, dreka familjare, ahengje, dasma, takime biznesore, shetitje ne natyre me kuaj, kend te lojrave per femije e shume mundesi tjera.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <p>Reviewed 10 day ago</p>
                                    </div>
                                    <div class="customer-rating">6.0</div>
                                </div>
                                <p class="customer-text">I liked everything, you must go and visit this place. Delicious food, perfect view it is like country side. I have enjoyed riding the horses.</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Don't even bother to go on the summer.
Service is horrible and waiters are worst. You call them for bill and they never show, its like disrespect for customers also unprofessional .</p>
<span>1 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapvali.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Perlepnice <br> Gjilan 60000 <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Vali' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
