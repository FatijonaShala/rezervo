...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Natyra'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/natyra1.jpg" class="grid image-link">
                        <img src="foto/natyra1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/natyra2.jpg" class="grid image-link">
                        <img src="foto/natyra2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/natyra3.jpg" class="grid image-link">
                        <img src="foto/natyra3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
               <div class="swiper-slide">
                    <a href="foto/natyra1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Natyra</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description">Pamje e mrekullueshme</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Restaurant Natyra ofron ushqim traditcional me nje sherbim te shpejte, vend malor dhe nje peisazh te bukur.Po ashtu ofojne shtegun i bicikletave ku mund te shetitni aq sa te doni!</p>
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Great location on the mountain stream </p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">The staff is so cold with people...</p>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        ...
                        <div class="address">
                            ...
                            <p> Reqan <br> Prizren 20000 <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 07:30 am - 19:30 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Natyra' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
