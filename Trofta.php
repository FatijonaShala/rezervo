...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Trofta'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/trofta1.jpg" class="grid image-link">
                        <img src="foto/trofta1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/trofta2.jpg" class="grid image-link">
                        <img src="foto/trofta2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/trofta3.jpg" class="grid image-link">
                        <img src="foto/trofta3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                       <div class="swiper-slide">
                    <a href="foto/trofta1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Trofta</h5>
                    <p><span>$$$$$</span></p>
                    <p class="reserve-description"> Fish is our best option!</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Meny te pasur me te gjitha llojet e mishit dhe zgares,duke vequar menyne tone te veqante qe eshte peshku ku eshte specialiteti jone kryesor,e sidomos peshku "Trofta".</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Perfect place to have a meal and enjoy the beauties of Hotel Trofta!Restaurant has a very rich menu with various dishes. Fish is one of the preferred meals as the fish is cultivated at this place.Outside seating is very nice, there are seats which offer a great view and a very relaxing environment.Fish pools are all around the yard.Pretty much a place where you may enjoy yourself..</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text"> Was waiting to be served.At the end we left</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/maptrofta.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Rruga Bajram Gashi<br> Istog 31000 <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 08:00 am - 18:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Trofta' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
