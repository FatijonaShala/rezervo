...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Shtepia'" ;
...
<body>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/shtepiaalpike1.jpg" class="grid image-link">
                        <img src="foto/shtepiaalpike1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/shtepiaalpike2.jpg" class="grid image-link">
                        <img src="foto/shtepiaalpike2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/shtepiaalpike3.jpg" class="grid image-link">
                        <img src="foto/shtepiaalpike3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/shtepiaalpike1.jpg" class="grid image-link">
    ...
    <section class="reserve-block">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Shtepia Alpike Ranch</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Ushqim dhe pamje fantastike</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Kjo bujtinë dhe restorant ndodhet në një nga pikat më të larta të Rugovës. Ofrimi i pamjeve të bukura nga të gjitha cepat. Është vetëm 2 km larg qytetit Pejë. Ka dy bujtina të cilat janë shumë të bollshme dhe pastrohen çdo ditë. Lokalet e Alpine House Ranch janë 600 Ha, dhe ekziston gjithashtu një rrugë 8 km ku funksionon një furnizues uji çdo 2 km.
                            </p>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        <h6>One of the best restaurant in Peja</h6>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                ...
                                <p class="customer-text"> Location is amazing. Construction is traditional like. They also have a terrace with sitting places. It is family friendly with playgrounds for kids. The food was really tasty.
                                </p>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed 1 months ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">2.0</div>
                                </div>
                                <p class="customer-text">A beautiful place with stunning views! But the restaurant service is terrified of having to wait for peppers for 1 hour and when the food arrives it's completed. Not even in Bangladesh there is anyone in business! </p>
                                <span>11 people marked this review as helpful</span>
                                <a href="#"><span class="icon-like"></span>Helpful</a>
								<br><br><br>
<br><br><br>
<br><br><br>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapshtepia.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Rruga te Zatrat <br> Peja 30000 <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 07:30 am - 12:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Shtepia' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
