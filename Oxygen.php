...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Oxygen'" ;
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html">RRezervo ne KS</a>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/oxygen1.jpg" class="grid image-link">
                        <img src="foto/oxygen1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/oxygen2.jpg" class="grid image-link">
                        <img src="foto/oxygen2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/oxygen3.jpg" class="grid image-link">
                        <img src="foto/oxygen3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                   <div class="swiper-slide">
                    <a href="foto/oxygen1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Oxygen</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Ju mund ta shihni Gjakovën ashtu si e keni në dorë.</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Një restorant që ndodhet në Qabrati, qyteti i Gjakovës. Vendi është shumë i qetë dhe ofron ushqim të shijshëm. Shërbimi është shumë i mirë. Specialitetet në shtëpi janë shumë të shijshme.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Delicious food, nice Ambiente, good prices, great atmosphere</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Good spot but very unfriendly an unprofessional.</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapoxygen.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Qabrat <br> Gjakove 50000 <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Oxygen' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
