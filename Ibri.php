...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Ibri'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/ibri1.jpg" class="grid image-link">
                        <img src="foto/ibri1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/ibri2.jpg" class="grid image-link">
                        <img src="foto/ibri2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/ibri3.jpg" class="grid image-link">
                        <img src="foto/ibri3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                    <div class="swiper-slide">
                    <a href="foto/ibri1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Ibri</h5>
                    <p><span>$$$$$</span></p>
                    <p class="reserve-description"> Restaurant familjar, me traditë shumëvjecare!</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Restaurant Ibri është një prej restauranteve model e lider në regjionin e Mitrovicës.I themeluar në vitin 2002 me një vizion të kjartë, stafi menaxhues i Restaurant Ibri me punën e palodhshme dhe me plotë përkushtim, ka arritur qe ta shëndrrojë këtë nismë, në një storie suksesi jo vetëm në Mitrovicë por edhe në gjithë Kosovën..</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        <h6>Good food & service </h6>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed 3 month ago</p>
                                    </div>
                                    <div class="customer-rating">9.0</div>
                                </div>
                                <p class="customer-text">If you want to have a special day and away from the noise of the city you really need to come here.The food it’s so delicious and fresh.Service it’s amazing I want to say thanks to our waiter if you really like to have a good service and hospitality jus ask for Arian!</p>
								<span>29 people marked this review as helpful</span>
	...
	?>
                            ...
                            <div class="customer-content-wrap">
                                <div class="customer-content">
                                    <div class="customer-review">
                                        ...
                                        <span class="round-icon-blank"></span>
                                        <span class="round-icon-blank"></span>
                                        <p>Reviewed  34 days ago</p>
                                    </div>
                                    <div class="customer-rating customer-rating-red">1.0</div>
                                </div>
                                <p class="customer-text"> I don't like this place!</p>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapibri.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Mahalla Asmanoviq 1<br> Mitrovicë <br> Kosovo</p>
                        </div>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <p>Mon - Sun 08:00 am - 19:00 pm <br>
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Ibri' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        ...
                        <p>Copyright &copy; 2019. All rights reserved. Created by: Fatijona Shala | Rezervo..n`KS </p>
