...
error_reporting(0);
$query= "SELECT * FROM review WHERE emri_restaurantit= 'Fiona'" ;
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="foto/fiona1.jpg" class="grid image-link">
                        <img src="foto/fiona1.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/fiona3.jpg" class="grid image-link">
                        <img src="foto/fiona3.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="foto/fiona2.jpg" class="grid image-link">
                        <img src="foto/fiona2.jpg" class="img-fluid" alt="#">
                    </a>
                </div>
                      <div class="swiper-slide">
                    <a href="foto/fiona1.jpg" class="grid image-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Fiona</h5>
                    <p><span>$$$</span>$$</p>
                    <p class="reserve-description"> Mundësia më e mirë në qytet!</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-8 responsive-wrap">
                    <div class="booking-checkbox_wrap">
                        <div class="booking-checkbox">
                            <p>Restaurant FIONA” është një ndër restorantet më prestigjioze, në Mitrovicë. Me arkitekturën e tij unike, të projektuar në mënyrë origjinale, me paisje bashkohore, në mënyrë perfekte kombinohet eleganca dhe thjeshtësia e një interiori modern.
Me traditë familjare prej dekade dhe i pozicionuar në mënyrë perfekte, “Restaurant FIONA” është i njohur si pikë referimi, si një nga restorantet më mikpritës të qytetit, i cili u ofron mysafirëve të tij një eksperiencë të jashtëzakonshme, si dhe më të mirën nga kultura shqiptare.</p>
							</div>
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="booking-checkbox_wrap mt-4">
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">Excellent placeGood food and good prices!</p>
                        ...
                        <div class="customer-review_wrap">
                            ...
                            <div class="customer-content-wrap">
                                ...
                                <p class="customer-text">I don't like a service.</p>
	...
	?>
                ...
                <div class="col-md-4 responsive-wrap">
                    <div class="contact-info">
                        <img src="images/mapfiona.png" class="img-fluid" alt="#">
                        <div class="address">
                            <span class="icon-location-pin"></span>
                            <p> Rruga Sheshi Mehë Uka <br> Mitrovicë 40000 <br> Kosovo</p>
                        </div>
                        <div class="address">
...
error_reporting(0);
$query= "SELECT * FROM info WHERE emri_res= 'Fiona' ";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
